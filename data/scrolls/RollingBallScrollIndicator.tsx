...
import RollingBallScrollIndicator from '@/components/scrolls/rolling-ball-scroll-indicator';

export const rollingBallScrollIndicatorPreview = (
  <div className="h-full w-full flex items-center justify-center">
    <VideoPreview videoUrl="/demos/rolling-ball-scroll-indicator.mp4" />
  </div>
);

export const rollingBallScrollIndicator: Document = {
  sideBar: {
    group: 'Text',
  ...
  content: {
    sections: [
      {
        heading: 'Rolling Ball Scroll Indicator',
        content:
