...
import SphereScroll from '@/components/list-scroll/sphere-scroll';
import { images } from '../constants';

export const sphereScrollPreview = (
...
export const sphereScroll: Document = {
  sideBar: {
    group: 'Cards',
    name: 'Sphere Scroll',
    order: 3
  ...
  content: {
    sections: [
      {
        heading: 'Sphere Scroll',
        content:
          'A scrollable component that displays images in a sphere layout. As you scroll, the images animate with smooth transitions, scaling, and positioning effects to create an engaging visual experience.',
        sectionType: 'name'
      },
      {
        sectionType: 'preview',
