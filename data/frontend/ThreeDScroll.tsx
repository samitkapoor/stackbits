...
import ThreeDScroll from '@/components/ui/3d-scroll';

export const threeDScrollPreview = (
...
export const threeDScroll: Document = {
  sideBar: {
    group: 'Components',
    name: 'Three D Scroll',
    order: 1
  ...
  content: {
    sections: [
      ...
      cnCode,
      {
        ...
        description: 'Create a file 3d-scroll.tsx in your components folder and paste this code',
        code: `'use client';
