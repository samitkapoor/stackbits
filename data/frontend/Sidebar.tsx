...
export const sidebarPreview = (
  <div className="h-full w-full flex flex-col items-center justify-center gap-2">
    <VideoPreview videoUrl="/demos/sidebar.mp4" />
  </div>
);

export const sidebar: Document = {
  sideBar: {
    group: 'Buttons',
    name: 'Sidebar',
    order: 7
    ...
    sections: [
      {
        heading: 'Sidebar',
        content:
          'A collapsible navigation sidebar with smooth expand/collapse animations and hover previews. Features icon-based navigation with animated content panels that slide in and out seamlessly.',
      ...
      cnCode,
      {
        ...
        description: 'Create a file sidebar.tsx in your components folder and paste this code',
        code: `'use client';
