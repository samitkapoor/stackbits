...
import AiInput from '@/components/components/ai-input';

export const aiInputPreview = (
  <div className="h-full w-full flex items-center justify-center">
    <VideoPreview videoUrl="/demos/ai-input.mp4" />
  </div>
);
  ...
  content: {
    sections: [
      ...
      cnCode,
      {
        ...
        description: 'Create a file ai-input.tsx in your components folder and paste this code',
        code: `'use client';
...
`
      },
      {
        ...
        code: `<AiInput
  width="500px"
  backgroundColor="#0d0d0d" // TODO: Change this color to your website's background color
  onSubmit={async (value, file) => {
    console.log(value, file);
    await new Promise((resolve) => setTimeout(resolve, 3000));
  }}
