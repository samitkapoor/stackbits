...
export const fileInputPreview = (
  <div className="h-full w-full flex flex-col items-center justify-center overflow-hidden relative gap-5">
    <VideoPreview videoUrl="/demos/file-input.mp4" />
  </div>
);

export const fileInput: Document = {
  sideBar: {
    group: 'Components',
    name: 'File Input',
    order: 3
  ...
  content: {
    sections: [
      ...
      cnCode,
      {
        ...
        description: 'Create a file file-input.tsx in your components folder and paste this code',
        code: `'use client';
...
`
      },
      {
        heading: 'Usage',
        sectionType: 'usage',
        code: `<FileInput allowMultiple onFileChange={(files) => console.log(files)} />`
      }
    ]
  }
};
