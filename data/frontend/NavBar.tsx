...
export const navBarPreview = (
  <div className="h-full w-full flex flex-col items-center justify-center gap-2">
    <Image src="/navbar.png" alt="navbar" width={800} height={800} />
  </div>
);

export const navBar: Document = {
  sideBar: {
    group: 'Components',
    name: 'NavBar',
    order: 6
  ...
  content: {
    sections: [
      {
        heading: 'NavBar',
        content: 'An elegant navigation bar component for your website.',
      ...
      },
      {
        ...
        description: 'Create a file nav-bar.tsx in your components folder and paste this code',
        code: `'use client';
