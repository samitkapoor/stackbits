...
import RandomButton from '@/components/buttons/random-button';

export const randomButtonPreview = (
  <div className="h-full w-full flex items-center justify-center p-5 gap-2">
    <RandomButton>Random</RandomButton>
  </div>
);

export const randomButton: Document = {
  sideBar: {
    group: 'Buttons',
    name: 'Random Button',
    order: 1
  ...
  content: {
    sections: [
      {
        heading: 'Random Button',
        content:
          'A button that shows a question mark by default and displays random emojis scrolling when you hover over it. Perfect for adding fun, interactive elements to your interface.',
        sectionType: 'name'
      },
      {
        sectionType: 'preview',
      ...
      installDependenciesCode({ framerMotion: true, tailwindcss: true, clsx: true }),
      cnCode,
      {
        heading: 'Random Button',
        sectionType: 'component',
        description:
          'Create a file random-button.tsx in your components folder and paste this code',
...
`
      },
      {
        heading: 'Usage',
        sectionType: 'usage',
        code: `<RandomButton>Random</RandomButton>`
      }
    ]
  }
};
