    ...
    sections: [
      {
        ...
        content:
          'A button with a spinning border that moves around the button edge. The border changes color on hover and creates a smooth rotating effect around the button.',
