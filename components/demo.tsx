...
const GRADIENT_STYLES = {
  step1: `radial-gradient(circle at 100% 0%, #ffff00D5 0%, transparent 40%),
          radial-gradient(circle at 100% 50%, #000000D5 0%, transparent 40%),
          radial-gradient(circle at 100% 100%, #008080D5 0%, transparent 40%),
          radial-gradient(circle at 50% 100%, #ff4000D5 0%, transparent 40%),
          radial-gradient(circle at 0% 100%, #ff8000D5 0%, transparent 40%),
          radial-gradient(circle at 0% 50%, #cc0000D5 0%, transparent 40%),
          radial-gradient(circle at 0% 0%, #004d4dD5 0%, transparent 40%), 
          radial-gradient(circle at 0% 50%, #ffbf00D5 0%, transparent 40%)`,
  step2: `radial-gradient(circle at 100% 0%, #004d4dD5 0%, transparent 40%),
          radial-gradient(circle at 100% 50%, #000000D5 0%, transparent 40%), 
          radial-gradient(circle at 100% 100%, #008080D5 0%, transparent 40%),
          radial-gradient(circle at 50% 100%, #ffff00D5 0%, transparent 40%),
          radial-gradient(circle at 0% 100%, #ffbf00D5 0%, transparent 40%),
          radial-gradient(circle at 0% 50%, #ff8000D5 0%, transparent 40%),
          radial-gradient(circle at 0% 0%, #ff4000D5 0%, transparent 40%),
          radial-gradient(circle at 50% 0%, #cc0000D5 0%, transparent 40%)`,
  step3: `radial-gradient(circle at 100% 0%, #ff4000 0%, transparent 50%),
          radial-gradient(circle at 100% 50%, #000000 0%, transparent 50%),
          radial-gradient(circle at 100% 100%, #ff8000 0%, transparent 50%), 
          radial-gradient(circle at 50% 100%, #cc0000 0%, transparent 50%),
          radial-gradient(circle at 0% 100%, #004d4d 0%, transparent 50%),
          radial-gradient(circle at 0% 50%, #008080 0%, transparent 50%),
          radial-gradient(circle at 0% 0%, #ffff00 0%, transparent 50%),
          radial-gradient(circle at 50% 0%, #ffbf00 0%, transparent 60%)`
};
