...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white py-8 sm:py-12 lg:py-16 px-4 sm:px-8 lg:px-5">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-0 lg:justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
