...
const TopBar = () => {
  ...
  return (
    <div className="flex items-center justify-between ml-2 sm:ml-[50px] h-[60px] rounded-md border-[1px] border-yellow-500/40 fixed w-[calc(100%-20px)] sm:w-[calc(100%-100px)] top-5 z-50 bg-black/50 overflow-hidden">
